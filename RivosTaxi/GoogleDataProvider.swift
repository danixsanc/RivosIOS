...
//  RivosTaxi
//
//  Created by Alex RIos Cardoza on 09/12/15.
...
class GoogleDataProvider {
    ...
    {
        var urlString = "http://maps.googleapis.com/maps/api/place/nearbysearch/json?location=\(coordinate.latitude),\(coordinate.longitude)&radius=\(radius)&rankby=prominence&sensor=true"
